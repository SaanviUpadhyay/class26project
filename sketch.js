...
var computerCollision=  Matter.SAT.collides(
  ...
  computerBase.body
      ...
      if(baseCollision.computerCollision.collided,
        playerCollision.computerCollision.collided,
        computerCollision.computerCollision.collided){
